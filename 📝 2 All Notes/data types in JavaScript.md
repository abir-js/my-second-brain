...
|                                    | **Var**                            | **Let**        | **Const**                             |
| ---------------------------------- | ---------------------------------- | -------------- | ------------------------------------- |
| *Double Variable Initialization*   | `var a = 10;`<br>`var a = 20;`<br> | not possible   | not possible                          |
| **Access variable outside scope**  | global scope                       | function scope | function scope                        |
| **Assign value after declaration** | Yes                                | Yes            | No, have to assign during declaration |
...
|                               | **undefined**                                                           | **Null**                                       |
| ----------------------------- | ----------------------------------------------------------------------- | ---------------------------------------------- |
| **Temperature(API response)** | can't use undefined because it actually exists but we don't know value. | We can use Null in case if we don't know value |
